    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/lessons/{lessonId}/video-progress").hasRole("STUDENT")
                        .requestMatchers(HttpMethod.GET, "/api/lessons/{lessonId}/learning-state").hasRole("STUDENT")
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/admin/lessons/{lessonId}/quiz-attempts").hasRole("ADMIN")
                        ...
                        .requestMatchers("/api/student/final-assessment-status").hasRole("STUDENT")
                        .requestMatchers("/api/student/final-assessment-retake-payments/**").hasRole("STUDENT")
                        .requestMatchers("/api/student/final-assessment-retake-payments").hasRole("STUDENT")
